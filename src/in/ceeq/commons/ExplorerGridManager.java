...
public class ExplorerGridManager extends BaseAdapter implements MultiChoiceModeListener
{
	...
	public static ExplorerGridManager getInstance(Context context, GridView gridView) {
		return new ExplorerGridManager(context, gridView);
	}

	public ExplorerGridManager(Context context, GridView gridView) {
